...
@pytest.mark.parametrize('input_number, expected_result', [
    ...
    (11, "november"), (12, "december"), (0, "out of range"), (13, "out of range"),
    (-10, "out of range"), (22, "out of range"), (1.1, "input integer"),
    (13.1, "out of range"), ("a", "input integer"), ("#", "input integer"), 
